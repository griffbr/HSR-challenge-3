...
var SequencedValidator = (function (_super) {
    ...
    SequencedValidator.prototype.executeSequence = function (sequence, result, context) {
        return __awaiter(this, void 0, void 0, function () {
            var virtualDevice, _i, _a, test_1, resultItem, validator, phrases, _b, errors, err_1, resultItem, validator, error;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        _b = resultItem;
                        return [4, virtualDevice.message(test_1.input, false, phrases)];
                    case 4:
                        _b.actual = _c.sent();
                    ...
                    case 5:
                        ...
                        validator.resultItem.result = "failure";
                        validator.resultItem.status = "done";
                        error = new VirtualDeviceValidator_1.ValidatorError(test_1.input, undefined, undefined, "SystemError: " + err_1.message);
