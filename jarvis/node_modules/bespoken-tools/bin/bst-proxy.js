...
program
    ...
    console.log(chalk.hex(logging_helper_1.LoggingHelper.LINK_COLOR)(url_mangler_1.URLMangler.mangleNoPath(global_1.Global.config().sourceID(), global_1.Global.config().secretKey())));
